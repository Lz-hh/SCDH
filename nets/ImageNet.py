...
# class ImageNet(nn.Module):
#     def __init__(self, y_dim, bit, num_classes, norm=True, mid_num1=1024 * 8, mid_num2=1024 * 8, hiden_layer=3):
#         """
#         :param y_dim: dimension of tags
#         :param bit: bit number of the final binary code
...
#最终版
class ImageNet(nn.Module):
    def __init__(self, y_dim, bit, num_classes, norm=True, mid_num1=1024 * 8, mid_num2=1024 * 8, hiden_layer=3, dropout_rate=0.1):
        """
        :param y_dim: dimension of tags
        :param bit: bit number of the final binary code
        :param num_classes: number of classes for the classification task
